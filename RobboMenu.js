...
//    this.QCA.searchQuadcopterDevices();
  ...
  let mainWork = this.props.red_cpp.workspace;
//  Blockly.Arduino.variableDB_.setVariableMap(mainWork.getVariableMap());
 //console.log(mainWork.YARIK_PIDOR);
    let a = Blockly.Arduino.workspaceToCode(mainWork);
    console.warn(a);
  }
  ...
  return (
      ...
      <div id="robbo-menu" className={classNames(
          ...
          <div id="trigger-color-corrector-table-4" onClick={this.triggerColorCorrectorTable.bind(this,4)} className={classNames(
            ...
            <div id="firmware-compile" onClick={this.compile_firmware.bind(this)} className={classNames(
...
const mapStateToProps =  state => ({
    ...
    red_cpp:state.scratchGui.red_cpp
